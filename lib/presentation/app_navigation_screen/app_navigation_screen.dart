                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildScreenTitle(
                          context,
                          screenTitle: "Splash screan",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.splashScreanScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "Continue with E-mail",
                          onTapScreenTitle: () => onTapScreenTitle(
                              context, AppRoutes.continueWithEMailScreen),
                        ),
                        _buildScreenTitle(
                          context,
                          screenTitle: "Leaderboard - Tab Container",
                          // onTapScreenTitle: () => onTapScreenTitle(
              ...
              children: [
                ...
                Align(
                  ...
                  child: Padding(
                    padding: EdgeInsets.symmetric(horizontal: 20.h),
                    child: Text(
                      "Home: الوقت و الممشى و الهدف - Container",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        color: Color(0XFF000000),
                        fontSize: 20.fSize,
